...
namespace GUI
{
    public partial class frmConsultaPlanoContas : Form
    {
        public int codigo = 0;
        ...
        private void frmConsultaPlanoContas_Load(object sender, EventArgs e)
        {
            btBusca_Click(sender, e);
            dgvDados.Columns[0].HeaderText = "Código";
            dgvDados.Columns[0].Width = 50;
            dgvDados.Columns[1].HeaderText = "Plano";
            dgvDados.Columns[1].Width = 380;
